 ...
 */
/**
 * This plugin is meant to be used in conjunction with the Greensock Animation Platform.
...
;(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    // CommonJS
    factory(require('scrollmagic'), require('gsap'))
  } else {
    // Browser globals
    factory(
   ...
   * This only affects scenes with a duration. If `tweenChanges` is set to `true`, the progress update when scrolling will not be immediate, but instead the animation will smoothly animate to the target state.
  ...
  ScrollMagic.Scene.extend(function () {
     ...
     *
     * @param {(object|string)} TweenObject - A TweenMax, TweenLite, TimelineMax or TimelineLite object that should be animated in the scene. Or an element selector, using the node element directly.
     * @param {(number|object)} duration - A duration for the tween, or tween parameters. If an object containing tween parameters is supplied, a default duration of 1 will be used.

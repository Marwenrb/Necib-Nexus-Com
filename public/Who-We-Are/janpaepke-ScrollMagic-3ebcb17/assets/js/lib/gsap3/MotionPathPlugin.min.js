!(function (t, e) {
  ...
  function sliceRawPath(t, e, n) {
    ...
    if (p || a) {
      if (
        (x(c, y, T, d.t) &&
          ...
          L
            ...
            : y <= w + 1 && !R && (w++, M && (b -= T))),
        m.t ? x(c, w, b, m.t) && (R && i && y++, r && w++) : (w--, r && y--),
        (h = []),
        (g = 1 + (u = c.length) * a),
        (f = y),
        r)
      ...
      for (
        i = subdivideSegment(P, T, L ? d.t / m.t : d.t),
          M && (s += i),
          v.splice(b + s + 2),
          i && P.splice(0, T + i),
          l = c.length;
  ...
  function measureSegment(t, e, n) {
    ...
    if (N) for (N -= A; L < R.length; L++) R[L] += N
    if (R.length && _)
      for (
        t.totalLength = w = R[R.length - 1] || 0,
          t.minLength = _,
          P = v = 0,
          r = 0;
        r < w;
    ...
    if (t !== s || e !== l) {
      ...
      for (G = 0; G < V; G++)
        (m = Z((a = z + G * k))),
          ...
          (N = Z((a += k))),
          (A = U(a)),
          I.push(m - E * v, v + E * m, N + E * A, A - E * N, N, A)
      for (G = 0; G < I.length; G += 2)
        (m = I[G]),
          (v = I[G + 1]),
          (I[G] = m * j + v * Y + S),
          (I[G + 1] = m * X + v * q + _)
      return (I[G - 2] = s), (I[G - 1] = l), I
    }
  }
    ...
    for (e = 0; e < P; e++)
      if (
        ...
        (u = m),
          (g = v),
          ('C' !== c && 'S' !== c) ||
            ((u += m - s[s.length - 4]), (g += v - s[s.length - 3])),
          i || (m = v = 0),
          s.push(u, g, r, a, (m += 1 * p[e + 3]), (v += 1 * p[e + 4])),
          (e += 4)
      else if ('Q' === o)
        (u = m + (2 / 3) * (r - m)),
          (g = v + (2 / 3) * (a - v)),
          ...
          (m += 1 * p[e + 3]),
          (v += 1 * p[e + 4]),
          s.push(u, g, m + (2 / 3) * (r - m), v + (2 / 3) * (a - v), m, v),
          (e += 4)
      else if ('T' === o)
        (u = m - s[s.length - 4]),
          (g = v - s[s.length - 3]),
          ...
          (e += 2)
      else if ('H' === o) ff(m, v, (m = r), v), (e += 1)
      else if ('V' === o) ff(m, v, m, (v = r + (i ? v - m : 0))), (e += 1)
      else if ('L' === o || 'Z' === o)
        'Z' === o && ((r = l), (a = h), (s.closed = !0)),
          ('L' === o || 0.5 < H(m - r) || 0.5 < H(v - a)) &&
            (ff(m, v, r, a), 'L' === o && (e += 2)),
          (m = r),
          (v = a)
      else if ('A' === o) {
        ...
        ;(m = s[s.length - 2]), (v = s[s.length - 1]), (e += 7)
      } else console.log(x)
    return (
      (e = s.length) < 6
        ? (d.pop(), (e = 0))
      ...
      (r = P),
        ...
        (P === r && w === a) ||
          (n < o
            ...
            : ((i = L(u, l)),
              b.push(O(P - Z(i) * f), O(w - U(i) * f)),
              (i = L(M, T)),
              b.push(O(P), O(w), O(P + Z(i) * c), O(w + U(i) * c))))
  ...
  function T(t, e) {
    if (
      ...
      (h ||
        (function _setDoc(t) {
          ...
          return (
            (u = window),
            (v = new G()),
            e && ((g = (h = e).documentElement), (f = e.body)),
            e
          )
        })(t))
    ) {
      var n = S(t),
        ...
        l = h.createElementNS
          ? h.createElementNS(r.replace(/^https/, 'http'), a)
          : h.createElement(a)
      return (
        e &&
          (n
  ...
  function getGlobalMatrix(t, e) {
    ...
    var n = S(t) ? M : B,
      r = (function _placeSiblings(t) {
        ...
        return t === u
          ? t
          : (l.length || l.push(T(t, 1), T(t, 2), T(t, 3)),
            (e = i ? m : c),
            i
              ? ((r = s ? { x: 0, y: 0 } : t.getBBox()),
                (n = t.transform.baseVal).length
      ...
      l = new G(
        ...
        a.left +
          (function _getDocScrollLeft() {
            return (
              u.pageXOffset || h.scrollLeft || g.scrollLeft || f.scrollLeft || 0
            )
          })(),
        a.top +
          (function _getDocScrollTop() {
            return (
              u.pageYOffset || h.scrollTop || g.scrollTop || f.scrollTop || 0
            )
          })()
      )
    return s.removeChild(r), e ? l.inverse() : l
  }
  /*!
  ...
  function ga(t, e, n, r, a, o, i) {
    return (
      (e =
        'cubic' === i.type
          ? [e]
          : (e.unshift(ea(n, r, i.unitX), a ? ea(n, a, i.unitY) : 0),
            i.relative && fa(e),
  ...
  var I,
    ...
    Y = ['y', 'translateY', 'top', 'marginTop'],
    o = Math.PI / 180,
    q = function _align(t, e, n) {
      var r,
        a,
        o,
        i,
    ...
    $ = function _addDimensionalPropTween(t, e, n, r, a, o) {
      var i = e._gsap,
        s = (t._pt = new k(t._pt, e, n, 0, 0, ha, 0, i.set(e, n, t)))
      ;(s.u = E(i.get(e, n, o)) || 0),
        (s.path = r),
        (s.pp = a),
        t._props.push(n)
    ...
    a = {
      ...
      register: function register(t, e, n) {
        ;(E = (I = t).utils.getUnit), (j = I.utils.toArray), (k = n)
      },
      init: function init(t, e) {
        ...
        if (
          ...
          (this.rotate = h || 0 === h) &&
            ...
            (this.ru = E(t._gsap.get(t, this.rProp)) || 0)),
          !Array.isArray(s) || 'closed' in s || 'number' == typeof l)
        )
          cacheRawPathMeasurements(
            (n = u(q(getRawPath(e.path), t, e))),
            e.resolution
          ),
            i.push(n),
            $(this, t, e.x || 'x', n, 'x', e.unitX || 'px'),
            $(this, t, e.y || 'y', n, 'y', e.unitY || 'px')
        else {
          for (r in l) ~X.indexOf(r) ? (a = r) : ~Y.indexOf(r) && (o = r)
          for (r in (a && o
            ? i.push(
                ga(
                  this,
          ...
          l))
            r !== a &&
              r !== o &&
              i.push(ga(this, da([], s, r, 0), t, r, 0, u, e))
        }
      },
      ...
      arrayToRawPath: function arrayToRawPath(t, e) {
        var n = da(da([], t, (e = e || {}).x || 'x', 0), t, e.y || 'y', 1)
        return (
          e.relative && fa(n),

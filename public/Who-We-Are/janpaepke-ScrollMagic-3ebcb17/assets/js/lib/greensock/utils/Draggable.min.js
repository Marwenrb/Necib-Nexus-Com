  ...
  _gsScope._gsDefine(
    ...
    function (a, b, c) {
      var d,
        ...
        j,
        k,
        l = { css: {}, data: '_draggable' },
        m = { css: {}, data: '_draggable' },
        n = { css: {}, data: '_draggable' },
        o = { css: {} },
        ...
        s = { style: {}, appendChild: r, removeChild: r },
        t = _gsScope.document || {
        ...
        P = function (a) {
          D.push(a),
            1 === D.length && b.ticker.addEventListener('tick', O, this, !1, 1)
        },
        Q = function (a) {
        ...
        $ = function (a, b) {
          return (
            (a = a || window.event),
            (q.pageX = a.clientX + t.body.scrollLeft + u.scrollLeft),
            (q.pageY = a.clientY + t.body.scrollTop + u.scrollTop),
            b && (a.returnValue = !1),
            q
          )
        },
        ...
        ca = (
          'undefined' != typeof window
            ? window
            : t.defaultView || { getComputedStyle: function () {} }
        ).getComputedStyle,
        da = function (a, b) {
          return ca(
            a instanceof Element ? a : a.host || (a.parentNode || {}).host || a,
            b
          )
        },
        ...
        xa = function (a) {
          ...
          for (
            d = e.getBoundingClientRect(),
              ...
              s.scaleX = Math.sqrt(j.a * j.a + j.b * j.b),
              s.scaleY = Math.sqrt(j.d * j.d + j.c * j.c),
              void 0 === g && la(),
              s.borderBox &&
                !h &&
        ...
        Ka = function (a, b, c) {
          if (a.removeEventListener) {
            ...
            a.removeEventListener(d || b, c),
              d && b !== d && a.removeEventListener(b, c)
        ...
        Qa = function (a, b) {
          for (var c, d = a.length; --d > -1; )
            (c = a[d]),
              (c.ondragstart = c.onselectstart = b ? null : r),
              ba(c, 'userSelect', b ? 'text' : 'none')
        },
        Ra = (function () {
          var a,
          ...
          return (
            ...
            b.appendChild(c),
            e.appendChild(b),
            (a = c.offsetHeight + 18 > b.scrollHeight),
            e.removeChild(b),
            a
          )
        })(),
              ...
              ;(o = a.scrollTop),
                ...
                (!h ||
                  ...
                  (!h || b) &&
                    ...
                    (k.width = 'auto'),
                    (k.paddingRight = '0px'),
                    (s = Math.max(0, a.scrollWidth - a.clientWidth)),
                    s &&
                      (s +=
                        ia(a, 'paddingLeft') +
                        (Ra ? ia(a, 'paddingRight') : 0))),
                  ...
                  (k.width = '100%'),
                  (k.paddingRight = s + 'px'),
                  Ra && (k.paddingBottom = ia(a, 'paddingBottom', !0)),
                  B && (k.zoom = '1'),
                  (d = a.clientWidth),
                  (e = a.clientHeight),
                  (q = a.scrollWidth),
        ...
        Ta = function (d, g) {
          a.call(this, d),
            (d = _(d)),
            f || (f = p.com.greensock.plugins.ThrowPropsPlugin),
            (this.vars = g = N(g || {})),
            (this.target = d),
          ...
          var h,
                  ...
                  Wa = !1,
                    ...
                    L.scrollLeft =
                      null != window.pageXOffset
                        ...
                        ? u.scrollLeft
                        : t.body.scrollLeft,
                    f = Ma.pointerX - L.scrollLeft,
                    g = Ma.pointerY - L.scrollTop;
                  l && !c;
                    ...
                    Ea &&
                      ...
                      0 > k
                        ...
                        : f < e.left + _a &&
                          ...
                          (h = -Math.min(
                            b.scrollLeft,
                            (m * (1 - Math.max(0, f - e.left) / _a)) | 0
                          ))),
                      h && (b.scrollLeft += h)),
                    c &&
                      (h || j) &&
                      (window.scrollTo(b.scrollLeft, b.scrollTop),
                      rb(Ma.pointerX + h, Ma.pointerY + j)),
                    (l = b)
              }
              if (ca) {
                var n = Ma.x,
            ...
            eb = function (a, c) {
              ...
              d._gsTransform ||
                (!ya && !za) ||
                b.set(d, { x: '+=0', overwrite: !1, data: '_draggable' }),
                ya
                ...
                (ea || fa || ga) &&
                  ...
                  (ga &&
                    ...
                    (K.y = Ma.y),
                    (e = ga(K)),
                    e.x !== Ma.x && ((Ma.x = e.x), (ca = !0)),
                    e.y !== Ma.y && ((Ma.y = e.y), (ca = !0))),
                  ea &&
                    ((e = ea(Ma.x)),
                    e !== Ma.x &&
                      ((Ma.x = e), za && (Ma.rotation = e), (ca = !0))),
                  fa && ((e = fa(Ma.y)), e !== Ma.y && (Ma.y = e), (ca = !0))),
                ca && db(!0),
                a ||
                  ((Ma.deltaX = Ma.x - f),
                  (Ma.deltaY = Ma.y - g),
            ...
            fb = function () {
              ...
              ;(s = !1),
                i
                  ? (i.calibrate(),
                    (Ma.minX = D = -i.maxScrollLeft()),
                    (Ma.minY = O = -i.maxScrollTop()),
                    (Ma.maxX = w = Ma.maxY = G = 0),
                    (s = !0))
                  : g.bounds &&
                    ...
                    za
                      ...
                      ? ((a = g.bounds),
                        ...
                        (Ma.maxY = G = a.maxY))
                      : ((b = ka(d, d.parentNode)),
                        (Ma.minX = D = ia(d, Aa) + a.left - b.left),
                        (Ma.minY = O = ia(d, Da) + a.top - b.top),
                        (Ma.maxX = w = D + (a.width - b.width)),
                        (Ma.maxY = G = O + (a.height - b.height))),
                    D > w && ((Ma.minX = w), (Ma.maxX = w = D), (D = Ma.minX)),
                    O > G && ((Ma.minY = G), (Ma.maxY = G = O), (O = Ma.minY)),
                    za && ((Ma.minRotation = D), (Ma.maxRotation = w)),
                    (s = !0)),
                g.liveSnap &&
                  ((c = g.liveSnap === !0 ? g.snap || {} : g.liveSnap),
                  (e = c instanceof Array || 'function' == typeof c),
                  za
                    ? ((ea = nb(e ? c : c.rotation, D, w, 1)), (fa = null))
                    : c.points
                    ? (ga = ob(
                        e ? c : c.points,
                        D,
            ...
            ib = function (a, b) {
              ...
              a && f
                ? (a === !0 &&
                    ...
                    za
                      ? (a.rotation = Oa(Ma, e ? c : c.rotation, w, D, 1, b))
                      : (Ea &&
                          (a[Aa] = Oa(
                            Ma,
                  ...
                  (Ma.tween = h =
                    f.to(
                      ...
                      Math.max(g.minDuration || 0, g.maxDuration || 0) || 2,
                      isNaN(g.minDuration)
                        ? 0 === j ||
            ...
            kb = function () {
              ...
              jb(!1),
                ...
                ca && (rb(Ma.pointerX, Ma.pointerY), db(!0)),
                i
                  ? (fb(), (r = i.top()), (q = i.left()))
                  : (lb() ? (eb(!0, !0), fb()) : Ma.applyBounds(),
                    za
                      ? ((aa = Ma.rotationOrigin = Ca(d, { x: 0, y: 0 })),
                        eb(!0, !0),
                        (q = Ma.x),
                        (r = Ma.y =
                          Math.atan2(aa.y - Ma.pointerY, Ma.pointerX - aa.x) *
                          y))
            ...
            ob = function (a, b, c, d, e, f, g) {
              return (
                ...
                'function' == typeof a
                  ...
                  ? function (b) {
                      for (
                        var c, d, e, g, h = a.length, i = 0, j = z;
                        --h > -1;
                ...
                if (
                  ...
                  Ia[a.type]
                    ? ((la =
                      ...
                      Ja(la, 'touchend', sb),
                      Ja(la, 'touchmove', qb),
                      Ja(la, 'touchcancel', sb),
                      Ja(t, 'touchstart', Na))
                    : ((la = null), Ja(t, 'mousemove', qb)),
                  (sa = null),
                  Ja(t, 'mouseup', sb),
                  a && a.target && Ja(a.target, 'mouseup', sb),
                  (ha = ab.call(Ma, a.target) && !g.dragClickables && !c))
                )
                  return (
                    Ja(a.target, 'change', sb),
                    ja(Ma, 'pressInit', 'onPressInit'),
                    ja(Ma, 'press', 'onPress'),
                    void Qa(Ra, !0)
                  )
                if (
                  ((ra =
                    !la ||
                    Ea === Fa ||
                    Ma.vars.allowNativeTouchScrolling === !1 ||
                    (Ma.vars.allowContextMenu &&
                      a &&
                      (a.ctrlKey || a.which > 2))
                      ? !1
                      : Ea
                  ...
                  a.changedTouches
                    ? ((a = U = a.changedTouches[0]), (Y = a.identifier))
                    : a.pointerId
                    ? (Y = a.pointerId)
                    : (U = Y = null),
                  H++,
                  ...
                  ja(Ma, 'pressInit', 'onPressInit'),
                  (ra || Ma.autoScroll) && Z(d.parentNode),
                  !d.parentNode ||
                    !Ma.autoScroll ||
                    i ||
                    za ||
                    ...
                    C.parentNode ||
                    d.getBBox ||
                    ((C.style.width = d.parentNode.scrollWidth + 'px'),
            ...
            rb = function (a, b) {
              ...
              ;(Ma.pointerX = a),
                (Ma.pointerY = b),
                za
                  ? ((f = Math.atan2(aa.y - b, a - aa.x) * y),
                    (g = Ma.y - f),
                    g > 180
                      ? ((r -= 360), (Ma.y = f))
                      : -180 > g && ((r += 360), (Ma.y = f)),
                    Ma.x !== q || Math.abs(r - f) > Ga
                      ? ((Ma.y = f), (e = q + (r - f) * i))
                      : (e = q))
                  : (ma &&
                ...
                (ea || fa || ga) && (Ma.x !== e || (Ma.y !== f && !za))
                  ? (ga &&
                      ((K.x = e), (K.y = f), (h = ga(K)), (e = h.x), (f = h.y)),
                    ea && (e = ea(e)),
                    fa && (f = fa(f)))
                  : s &&
                    (e > w
                ...
                (Ma.x !== e || (Ma.y !== f && !za)) &&
                  (za
                    ? ((Ma.endRotation = Ma.x = Ma.endX = e), (ca = !0))
                    : (Fa && ((Ma.y = Ma.endY = f), (ca = !0)),
                      Ea && ((Ma.x = Ma.endX = e), (ca = !0))),
                  !Ma.isDragging &&
                    Ma.isPressed &&
            ...
            sb = function (a, c) {
              if (
                ...
                (!a ||
                  ...
                  c ||
                  !(
                    (a.pointerId && a.pointerId !== Y) ||
                    (a.changedTouches && !La(a.changedTouches, Y))
                  ))
              ) {
                Ma.isPressed = !1
                var e,
                  ...
                  m = Ma.isDragging,
                  n =
                    Ma.vars.allowContextMenu && a && (a.ctrlKey || a.which > 2),
                  o = b.delayedCall(0.001, mb)
                if (
                  (la
                    ? (Ka(la, 'touchend', sb),
                      Ka(la, 'touchmove', qb),
                      Ka(la, 'touchcancel', sb),
                      Ka(t, 'touchstart', Na))
                    : Ka(t, 'mousemove', qb),
                  Ka(t, 'mouseup', sb),
                  a && a.target && Ka(a.target, 'mouseup', sb),
                  (ca = !1),
                  ha && !n)
                )
                  return (
                    a && (Ka(a.target, 'change', sb), (Ma.pointerEvent = l)),
                    Qa(Ra, !1),
                ...
                if ((Q(db), !za))
                  for (f = Ra.length; --f > -1; )
                    ba(Ra[f], 'cursor', g.cursor || 'move')
                if ((m && ((Va = J = A()), (Ma.isDragging = !1)), H--, a)) {
                  if (
                    (B && (a = $(a, !1)),
                    (e = a.changedTouches),
                    e && ((a = e[0]), a !== U && a.identifier !== Y))
                  ) {
                    for (
                      f = e.length;
                      --f > -1 && (a = e[f]).identifier !== Y;
                ...
                return (
                  n && l
                    ? (l.preventDefault(),
                      ...
                      ja(Ma, 'release', 'onRelease'))
                    : l && !m
                    ? (na && (g.snap || g.bounds) && ib(g.throwProps),
                      ja(Ma, 'release', 'onRelease'),
                      (I && 'touchmove' === l.type) ||
                        -1 !== l.type.indexOf('cancel') ||
                        (ja(Ma, 'click', 'onClick'),
                        A() - bb < 300 &&
                          ja(Ma, 'doubleclick', 'onDoubleClick'),
                        ...
                        I || l.defaultPrevented || b.delayedCall(1e-5, k)))
                    : (ib(g.throwProps),
                      B ||
                        Ma.allowEventDefault ||
                        !l ||
                        (!g.dragClickables && ab.call(Ma, l.target)) ||
                        !m ||
                        (ra && (!sa || ra !== sa)) ||
                        l.cancelable === !1 ||
                        (l.preventDefault(),
                        l.preventManipulation && l.preventManipulation()),
                      ja(Ma, 'release', 'onRelease')),
                  lb() && o.duration(Ma.tween.duration()),
          ...
          ;(da = Ta.get(this.target)),
            da && da.kill(),
            (this.startDrag = function (a, b) {
              var c, e, f, g
              pb(a || Ma.pointerEvent, !0),
                b &&
                  !Ma.hitTest(a || Ma.pointerEvent) &&
                  ((c = Xa(a || Ma.pointerEvent)),
                  (e = Xa(d)),
                  (f = vb({
                    x: c.left + c.width / 2,
                    y: c.top + c.height / 2,
            ...
            (this.update = function (a, b, c) {
              ...
              return (
                jb(!b),
                a ? Ma.applyBounds() : (ca && c && db(!0), eb(!0)),
                b && (rb(Ma.pointerX, Ma.pointerY), ca && db(!0)),
                Ma.isPressed &&
                  !b &&
                  ...
                  kb(),
                Ma.autoScroll &&
                  (Z(d.parentNode), (Wa = Ma.isDragging), db(!0)),
                Ma.autoScroll && (W(d, tb), V(d, tb)),
                Ma
              )
            }),
              ...
              if ('soft' !== a) {
                for (j = Ra.length; --j > -1; )
                  (k = Ra[j]),
                    ...
                    this.vars.allowContextMenu || Ja(k, 'contextmenu', cb)
                Qa(Ra, !1)
              }
              return (
                V(d, tb),
            ...
            (this.disable = function (a) {
              var b,
                c,
                e = Ma.isDragging
              if (!za) for (b = Ra.length; --b > -1; ) ba(Ra[b], 'cursor', null)
              if ('soft' !== a) {
                for (b = Ra.length; --b > -1; )
                  (c = Ra[b]),
                    ba(c, 'touchCallout', null),
                    ba(c, 'touchAction', null),
                    Ka(c, 'mousedown', pb),
                    Ka(c, 'touchstart', pb),
                    Ka(c, 'click', ub),
                    Ka(c, 'contextmenu', cb)
            ...
            (this.kill = function () {
              return (
                ...
                b.killTweensOf(i || d, !0, Ua),
                Ma.disable(),
                b.set(Ra, { clearProps: 'userSelect' }),
                delete E[d._gsDragID],
                Ma
              )
            }),
            -1 !== xa.indexOf('scroll') &&

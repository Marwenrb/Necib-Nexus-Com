...
;(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
      ...
      ;(a.type = 2),
        ...
        (a.setRatio = function (b) {
          ...
          if (1 !== b || (f._time !== f._duration && 0 !== f._time))
            if (
              b ||
              (f._time !== f._duration && 0 !== f._time) ||
              f._rawPrevTime === -1e-6
            )
              if (
                ((h = a.c * b + a.s),
                a.r ? (h = Math.round(h)) : k > h && h > -k && (h = 0),
                d)
              )
                if (1 === d) {
    ...
    b = function (b, c) {
      ...
      for (
        b.scale
          ...
          : b.rotationZ && (b.rotation = b.rotationZ);
        d;

      )
        'function' == typeof b[d.p]
          ? a(d, c, b[d.p])
          : e &&
            'bezier' === d.n &&
            -1 !== d.plugin._overwriteProps.join('').indexOf('rotation') &&
            (d.data.mod = b.rotation),
          (d = d._next)
    },
            ...
            g.pg
              ? 'css' === g.t._propName
                ...
                : g.t !== f &&
                  ((a = e[g.t._propName]),
                  (g.t._tween = d),
                  g.t._mod('object' == typeof a ? a : e))
              : 'function' == typeof a &&
                (2 === g.f && g.t
                  ? ((g.t._applyPT.m = a), (g.t._tween = d))
                  : (this._add(g.t, g.p, g.s, g.c, a),
                    c && (c._prev = g._prev),
                    g._prev
                      ? (g._prev._next = c)
                      : d._firstPT === g && (d._firstPT = c),
  ...
  ;(d._add = function (a, b, c, d, e) {
    ...
    (d = _gsScope._gsDefine.globals.TweenLite.version.split('.')),
    Number(d[0]) <= 1 &&
      Number(d[1]) < 19 &&
      _gsScope.console &&

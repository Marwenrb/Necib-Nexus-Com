    ...
    f = _gsScope._gsDefine.plugin({
      ...
      init: function (b, c, d, f) {
        ...
        if (
          ...
          (this._svg = b.getBBox && ('TEXT' === h || 'TSPAN' === h)),
          !('innerHTML' in b || this._svg))
        )
          return !1
        if (
          ((this._target = b),
          'object' != typeof c && (c = { value: c }),
          void 0 === c.value)
        )
          return (this._text = this._original = ['']), !0
        for (
          this._delimiter = c.delimiter || '',
            this._original = e(a(b).replace(/\s+/g, ' '), this._delimiter),
            this._text = e(c.value.replace(/\s+/g, ' '), this._delimiter),
            this._runBackwards = d.vars.runBackwards === !0,
            this._runBackwards &&
              ((h = this._original),
              (this._original = this._text),
              (this._text = h)),
            'string' == typeof c.newClass &&
              ((this._newClass = c.newClass), (this._hasClass = !0)),
            'string' == typeof c.oldClass &&
              ((this._oldClass = c.oldClass), (this._hasClass = !0)),
            h = this._original.length - this._text.length,
            g = 0 > h ? this._original : this._text,

...
const Icon = ({ name, size = 24, color = "currentColor", className, onClick, animated = true }) => {
  ...
  return (
    <div className={s.iconBrowser}>
      <div className={s.searchContainer}>
        <Icon name="search" size={20} animated={false} className={s.searchIcon} />
        <input
          type="text"
        ...
        >
          ...
          <div className={s.codeExample}>
            ...
            <button 
              ...
              onClick={() => {
                navigator.clipboard.writeText(`<Icon name="${selectedIcon}" size={24} />`);
              }}
            >
              Copy
            </button>
